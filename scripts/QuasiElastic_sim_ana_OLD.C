...
int QuasiElastic_sim_ana(const std::string configfilename, std::string filebase="/volatile/halla/sbs/ktevans/QE_sim")
{
  ...
  */
  ...
  double T_epx;         Tout->Branch("epx", &T_epx, "epx/D");
  double T_epy;         Tout->Branch("epy", &T_epy, "epy/D");
  double T_epz;         Tout->Branch("epz", &T_epz, "epz/D");
  double T_npx;         Tout->Branch("npx", &T_npx, "npx/D");
  double T_npy;         Tout->Branch("npy", &T_npy, "npy/D");
  double T_npz;         Tout->Branch("npz", &T_npz, "npz/D");
  //track
