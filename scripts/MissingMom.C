...
void MissingMom(const char *kinematic, int kin)
{
  ...
  TProfile* h_prof_pol_p = new TProfile("h_prof_pol_p", "pol_prof_p", 50.0, -3.5, 3.0, -0.5, 1.5);
  TProfile* h_prof_pol_n = new TProfile("h_prof_pol_n", "pol_prof_n", 50.0, -3.5, 3.0, -0.5, 1.5);
  ...
  TF1 *fitn = new TF1("fitn", "[0] + [1]*x + [2]*x*x + [3]*x*x*x + [4]*x*x*x*x + [5]*x*x*x*x*x + [6]*x*x*x*x*x*x + [7]*x*x*x*x*x*x*x + [8]*x*x*x*x*x*x*x*x + [9]*x*x*x*x*x*x*x*x*x", -3.5, 3.0);
